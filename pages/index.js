  ...
  return (
    <div>
          ...
          <div className="max-w-6xl mx-auto px-4 lg:px-10">
            <div class="grid grid-cols-3 mt-8 items-center sm:mx-10 lg:mx-0">
              ...
              <div className="col-span-3 px-20 sm:col-span-3 sm:px-40 md:px-52 lg:p-0 lg:col-span-1 ">
                <div className="flex border-8 border-white bg-alt rounded-2xl">
                  <Image className="" src={FLSGif} />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="w-full bg-gray-900">
        <div className="max-w-6xl mx-auto px-4 py-16 lg:px-10 lg:flex justify-between text-center lg:text-left">
          <div>
            <div className="lg:flex items-center justify-center">
              ...
              <div className="lg:ml-5">
                <p className="font-black text-2xl">Funny Looking Strangers</p>
                <p className="text-sm font-light">
                  10,555 unique randomly generated NFTs
                </p>
              </div>
            </div>
            <div>
              <p className="mt-10 text-gray-500 text-base">
                ©2021 DS_Studios. All rights reserved.
              </p>
            </div>
          </div>
          <div className="flex items-center justify-center mt-6 lg:mt-0">
            <div>
              ...
              <div className="mt-4 space-x-3">
                ...
                <button className="btn-social-alt hover:text-btnmain">
                  <div className="text-black w-4 h-4 hover:text-btnmain transition-colors">
                    <svg
                      width="100%"
                      height="100%"
                      viewBox="0 0 90 90"
